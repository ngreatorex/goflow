...
type FlowMessage struct {
	...
	InBytes              uint64   `protobuf:"varint,1000,opt,name=InBytes,proto3" json:"InBytes,omitempty"`
	OutBytes             uint64   `protobuf:"varint,1001,opt,name=OutBytes,proto3" json:"OutBytes,omitempty"`
	InPackets            uint64   `protobuf:"varint,1002,opt,name=InPackets,proto3" json:"InPackets,omitempty"`
	OutPackets           uint64   `protobuf:"varint,1003,opt,name=OutPackets,proto3" json:"OutPackets,omitempty"`
...
func (m *FlowMessage) GetInBytes() uint64 {
	if m != nil {
		return m.InBytes
	}
	return 0
...
func (m *FlowMessage) GetOutBytes() uint64 {
	if m != nil {
		return m.OutBytes
	}
	return 0
...
func (m *FlowMessage) GetInPackets() uint64 {
	if m != nil {
		return m.InPackets
	}
	return 0
...
func (m *FlowMessage) GetOutPackets() uint64 {
	if m != nil {
		return m.OutPackets
	}
	return 0
...
var fileDescriptor_0beab9b6746e934c = []byte{
	...
	,
}
